...
export default function AuthorListing() {
    ...
    const fetchBlog = async (page = variablesList.currentPage, term = '', status = '') => {
        ...
        try {
            ...
            const response = await insertData("api/author/getall", requestData, true);
                            ...
                            <div className="widget-box-2 wd-listing">
                                <div class="top d-flex justify-content-between align-items-center">
                                    ...
                                    <div style={{ display: "flex", alignItems: "center" }}>
                                        <div>
                                            <Link className="remove-file tf-btn primary" href="/create-author" style={{ marginRight: "20px" }}>Add Author</Link>
                                        </div>
                                        <div>
