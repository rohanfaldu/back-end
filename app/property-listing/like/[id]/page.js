...
export default function PropertyListing({params}) {
  const { id } = params;
  ...
  const fetchProperties = async (page = variablesList.currentPage, term = '', status = '') => {
    ...
    try {
      ...
      const response = await insertData("api/property/user-like-property", requestData, true);
                              ...
                              <tr key={property.property.id}>
                                ...
                                {/* <td>
                                  <div className="status-wrap">
                                    <Link href="#" className="btn-status" onClick={() => statusChange(property.property.id)}>
                                      {property.property.status ? "Active" : "Inactive"}
                                    </Link>
                                  </div>
                                </td> */}
                              </tr>
